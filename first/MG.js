...
jb && "Microsoft Internet Explorer" == "Netscape" ? (d.prototype.am = g,
    hb = 30) : jb && "Netscape" != "Netscape" ? (d.prototype.am = f,
...
if (null == qb) {
    ...
    if ("Netscape" == "Netscape" && "5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.89 Safari/537.36" < "5" && window.crypto) {
...
function rsaFingerprint(a, b) {
    var c = '{"user_agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.89","language":"zh-CN","color_depth":"24","pixel_ratio":"1","hardware_concurrency":"16","resolution":"1920,1080","available_resolution":"1920,1040","timezone_offset":"-480","session_storage":"1","local_storage":"1","indexed_db":"1","open_database":"1","cpu_class":"unknown","navigator_platform":"Win32","do_not_track":"unknown","regular_plugins":"Chrome PDF Plugin::Portable Document Format::application/x-google-chrome-pdf~pdf,Chrome PDF Viewer::","webgl_vendor":"Google Inc.~ANGLE (NVIDIA GeForce GT 710 Direct3D11 vs_5_0 ps_5_0)","adblock":"false","has_lied_languages":"false","has_lied_resolution":"false","has_lied_os":"false","has_lied_browser":"false","touch_support":"0,false,false","js_fonts":"Arial,Arial Black,Arial Narrow,Book Antiqua,Bookman Old Style,Calibri,Cambria,Cambria Math,Century,C"}'
        , d = "388368622d506e47d1de8e8b399c418d"
        , e = c.length
        , f = ""
        , g = new RSAKey;
    g.setPublic(a, b);
